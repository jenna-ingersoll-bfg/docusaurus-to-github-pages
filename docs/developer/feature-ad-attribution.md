...
AppsFlyer is integrated directly into the BFG SDK, and most of the functionality is already set up for you. Prior to configuring AppsFlyer, you must first integrate the BFG SDK into your game code.
...
<details>
  <summary>Update your Gradle dependencies</summary>
...
<details>
  <summary>Update your manifest with CHANNEL entry (Amazon Only)</summary>
...
<details>
  <summary>Add support for SKAdNetwork (SKAN)</summary>
...
<details>
  <summary>Update intent filters</summary>
...
- [AppsFlyer Help Center](https://support.appsflyer.com/hc/en-us) :arrow_upper_right: